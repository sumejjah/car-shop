...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { date: @history.date, product_id: @history.product_id, quantity: @history.quantity, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { date: @history.date, product_id: @history.product_id, quantity: @history.quantity, user_id: @history.user_id } }
